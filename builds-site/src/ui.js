...
export const styles = {
  ...
  logoBox: { width: 56, height: 56, flexShrink: 0, backgroundColor: "#FFFFFF", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center" },
  logoImg: { height: 42, width: "auto", display: "block" },
